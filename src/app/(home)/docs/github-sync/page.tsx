  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Keep your Luno projects and GitHub repos in perfect sync — automatically.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <DocsSteps steps={[
          ...
          { title: 'Choose a repo', description: 'Select an existing repo or create a new one. Luno registers a webhook on the repo automatically.' },
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          If you push commits directly to GitHub — from your local machine or another tool — Luno detects the push via webhook and pulls the changes back into your project automatically. Your version history will show the incoming commit as a new version.
        </p>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          If both Luno and GitHub modify the same file at the same time, a conflict is flagged in your project. You'll see a diff view showing both versions — pick which one to keep or merge them manually.
        </p>
        <DocsCallout type="warning">
          Always generate in Luno before pushing manually to GitHub to minimize conflicts.
        </DocsCallout>
      </div>
    </div>
  )
