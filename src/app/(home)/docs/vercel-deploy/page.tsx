  ...
  return (
    <div className="space-y-8">
      ...
      <DocsCallout type="info">
        Vercel deploy is an optional feature. It requires a Vercel account and token. Without it, you still get a live preview inside Luno.
      </DocsCallout>
      ...
      <div className="space-y-4">
        ...
        <DocsSteps steps={[
          ...
          { title: 'Add token to Luno', description: 'Go to Settings in the Luno app and paste your Vercel token. Vercel deploy is now enabled for all your projects.' },
          { title: 'Generate something', description: 'On your next generation, Luno will automatically deploy the app to Vercel and show you a live URL in the project header.' },
        ]} />
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          Every time you generate, Luno pushes the new code to your connected GitHub repo, and Vercel picks it up automatically via its GitHub integration. The live URL is updated within seconds of generation completing.
        </p>
      </div>
    </div>
  )
